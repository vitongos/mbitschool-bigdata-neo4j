...
#sudo sed -i -r 's/org\.neo4j\.server\.database\.location=data\/graph.db/org\.neo4j\.server\.database\.location=data\/cineasts.db/' /opt/neo4j/conf/neo4j-server.properties
